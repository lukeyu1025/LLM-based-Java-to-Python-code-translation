...
syn_df = pd.read_csv("batch_translation/syntax_results_structured_summary.csv")
func_df = pd.read_csv("batch_translation/functionality_results_structured_summary.csv")
sem_df = pd.read_csv("batch_translation/semantic_accuracy_results_structured_summary.csv")
read_df = pd.read_csv("batch_translation/readability_results_structured_summary.csv")
style_df = pd.read_csv("batch_translation/style_pylint_results_structured_summary.csv")

# === re-label strategy column ===
strategy_label = "CoT-StructuredSummary"
...
summary_csv_path = "batch_translation/evaluation_summary_structured_summary.csv"
summary_plot_path = "batch_translation/evaluation_summary_plot_structured_summary.png"
