import os
from translation import run_CoT_translation_pseudocode

# === Paths ===
BASE_JAVA_DIR = "../codenet_project/Project_CodeNet_Java250"
DIRECT_DIR = "batch_translation/direct"
COT_VARIANT_DIR = "batch_translation/CoT_variant_pseudocode"
...
for file in direct_files:
    ...
    run_CoT_translation_pseudocode(java_path, cot_out_path)
