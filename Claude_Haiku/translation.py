...
Now provide the corrected Python code if needed. Output only the corrected code block."""
    ...
    # Use fallback if Claude says the code is correct in natural language
    if (
            not refined_code
            or "correct" in reflection_output.lower()
            or "no corrections" in reflection_output.lower()
            or "no change" in reflection_output.lower()
            or "matches the logic" in reflection_output.lower()
            or "translation is accurate" in reflection_output.lower()
    ):
