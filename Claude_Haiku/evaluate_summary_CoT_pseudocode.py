...
syn_df = pd.read_csv("batch_translation/syntax_results_pseudocode.csv")
func_df = pd.read_csv("batch_translation/functionality_results_pseudocode.csv")
sem_df = pd.read_csv("batch_translation/semantic_accuracy_results_pseudocode.csv")
read_df = pd.read_csv("batch_translation/readability_results_pseudocode.csv")
style_df = pd.read_csv("batch_translation/style_pylint_results_pseudocode.csv")

# === re-label strategy column ===
strategy_label = "CoT-pseudocode"
...
summary_csv_path = "batch_translation/evaluation_summary_pseudocode.csv"
summary_plot_path = "batch_translation/evaluation_summary_plot_pseudocode.png"
