...
syn_df = pd.read_csv("batch_translation/syntax_results_annotated.csv")
func_df = pd.read_csv("batch_translation/functionality_results_annotated.csv")
sem_df = pd.read_csv("batch_translation/semantic_accuracy_results_annotated.csv")
read_df = pd.read_csv("batch_translation/readability_results_annotated.csv")
style_df = pd.read_csv("batch_translation/style_pylint_results_annotated.csv")

# === re-label strategy column ===
strategy_label = "CoT-annotated"
...
summary_csv_path = "batch_translation/evaluation_summary_annotated.csv"
summary_plot_path = "batch_translation/evaluation_summary_plot_annotated.png"
