...
# === Paths ===
batch_dir = "batch_translation/CoT_variant_structured_summary"
source_java_dir = "../codenet_project/Project_CodeNet_Java250"
output_csv_path = os.path.join("batch_translation", "semantic_accuracy_results_structured_summary.csv")
