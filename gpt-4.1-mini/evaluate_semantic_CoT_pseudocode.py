...
# === Paths ===
batch_dir = "batch_translation/CoT_variant_pseudocode"
source_java_dir = "../codenet_project/Project_CodeNet_Java250"
output_csv_path = os.path.join("batch_translation", "semantic_accuracy_results_pseudocode.csv")
...
# === LLM call ===
def generate(prompt: str, max_tokens=64) -> str:
