import os
from translation import run_CoT_translation_annotated_code

# === Paths ===
BASE_JAVA_DIR = "../codenet_project/Project_CodeNet_Java250"
DIRECT_DIR = "batch_translation/direct"
COT_VARIANT_DIR = "batch_translation/CoT_variant_annotated"
...
for file in direct_files:
    ...
    run_CoT_translation_annotated_code(java_path, cot_out_path)
